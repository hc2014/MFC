...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
      CW_USEDEFAULT, 0, 680, 440, nullptr, nullptr, hInstance, nullptr);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        {
            ...
            case IDM_EXIT:
                ...
                break;
			case IDM_NEW:
				MessageBox(NULL, TEXT("点击了新建菜单!"), NULL, MB_OK);
				break;
			case IDM_SAVE:
				MessageBox(NULL, TEXT("点击了保存菜单!"), NULL, MB_OK);
				break;
			case IDM_OPEN:
				MessageBox(NULL, TEXT("点击了打开菜单!"), NULL, MB_OK);
				break;
            default:
	...
	case WM_CREATE:
	{
		...
		edit_ip = CreateWindow(TEXT("edit"), TEXT("test"), WS_CHILD | WS_VISIBLE | WS_BORDER,
	...
	case WM_SIZE:
		MoveWindow(hWinRich, 20, 55, 625, 470, TRUE);
		break;
    default:
        return DefWindowProc(hWnd, message, wParam, lParam);
    }
