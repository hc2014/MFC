...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        layoutWidget->setGeometry(QRect(20, 250, 351, 36));
        ...
        mainTextEdit = new QTextEdit(Dialog);
        mainTextEdit->setObjectName(QStringLiteral("mainTextEdit"));
        mainTextEdit->setGeometry(QRect(20, 30, 341, 201));
...
namespace Ui {
    class Dialog: public TestDialog {};
} // namespace Ui
